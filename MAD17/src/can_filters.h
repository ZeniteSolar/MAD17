...
{
    // Group 0
    MCP2515_FILTER(CAN_FILTER_MSG_ALL), // Filter 0
    MCP2515_FILTER(CAN_FILTER_MSG_ALL), // Filter 1

    // Group 1
    MCP2515_FILTER(CAN_FILTER_MSG_ALL), // Filter 2
    MCP2515_FILTER(CAN_FILTER_MSG_ALL), // Filter 3
    MCP2515_FILTER(CAN_FILTER_MSG_ALL), // Filter 4
    MCP2515_FILTER(CAN_FILTER_MSG_ALL), // Filter 5

    MCP2515_FILTER(CAN_FILTER_MSG_ALL),             // Mask 0 (for group 0)
    MCP2515_FILTER(CAN_FILTER_MSG_ALL),             // Mask 1 (for group 1)
};
